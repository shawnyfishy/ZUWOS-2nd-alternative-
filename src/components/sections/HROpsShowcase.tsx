...
export default function HROpsShowcase() {
    ...
    return (
        <section className="w-full min-h-[auto] md:min-h-screen py-16 md:py-20 bg-coconut flex flex-col justify-center gap-12 md:gap-0 md:justify-between items-center relative">
            ...
            <div className="md:flex-grow w-full max-w-[1600px] mx-auto grid grid-cols-1 items-center relative z-10 px-6 md:px-12">
                ...
                <div className="col-start-1 row-start-1 justify-self-center w-full max-w-5xl flex justify-center relative px-8 pointer-events-none">
                    <div className="w-full max-w-3xl 2xl:max-w-4xl transform scale-100 lg:scale-90 transition-all duration-500 hover:scale-95 pointer-events-auto">
                        <MacBookFrame>
            ...
            <div className="shrink-0 w-full flex justify-center pt-8 pb-4 md:pb-8 z-20 px-6 relative z-20">
                <motion.h3 layout className="flex flex-wrap items-baseline justify-center gap-[0.4em] tracking-tight leading-none text-center">
                    <motion.span layout className="whitespace-nowrap text-base md:text-xl font-medium text-graphite/80">Total clarity. Total Control. Across Every</motion.span>
