...
export default function EmployeeOSShowcase() {
    ...
    return (
        <section ref={containerRef} className="w-full min-h-[auto] md:min-h-screen py-16 md:py-12 2xl:py-20 bg-coconut flex flex-col justify-center gap-12 md:gap-0 md:justify-between items-center relative overflow-hidden">

            {/* 1. Header (Top) */}
            <div className="shrink-0 text-center z-10 px-6 relative z-20 md:mb-12">
