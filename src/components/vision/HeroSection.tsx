...
const HeroSection = () => {
    ...
    return (
        <section
            ref={containerRef}
            className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white pt-24 pb-20"
        >
            ...
            <div className="z-10 text-center px-6 max-w-[1200px] mx-auto flex flex-col items-center gap-12">
                {/* Visual: Logo */}
                <div ref={shapesRef} className="mb-6 flex flex-col items-center">
                    {/* Placeholder for Logo - Using Typography as fallback since no SVG provided */}
                    <span className="font-display font-bold text-6xl md:text-8xl tracking-tighter text-graphite">ZUWOS</span>
                </div>

                <div className="max-w-5xl mx-auto">
                    <h1 ref={headlineRef} className="text-5xl md:text-7xl font-display font-bold tracking-tighter text-graphite leading-[1.1] mb-8">
                    ...
                    <p ref={subheadRef} className="text-lg md:text-2xl text-graphite/70 font-medium tracking-tight max-w-2xl mx-auto leading-relaxed">
