...
const IndigenousSection = () => {
    ...
    return (
        <section ref={sectionRef} className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 bg-coconut overflow-hidden">
            ...
            {/* Left: The Problem */}
            <div ref={leftRef} className="p-12 md:p-24 flex flex-col justify-center border-r border-gray-200/50 relative">
                <div className="max-w-xl mx-auto w-full">
                    <h2 className="text-display-sm font-display font-bold text-gray-300 mb-12 tracking-tighter leading-tight relative">
                        <span className="absolute -left-12 top-0 text-9xl text-gray-100 -z-10 select-none">?</span>
                        Big Tech sells <br />
            ...
            {/* Right: The Solution */}
            <div ref={rightRef} className="p-12 md:p-24 bg-white flex flex-col justify-center relative">
                <div className="max-w-xl mx-auto w-full">
