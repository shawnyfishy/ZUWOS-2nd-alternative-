...
const ProcurementView = () => {
    return (
        <div className="w-[100vw] h-screen flex-shrink-0 bg-blue-100 flex relative overflow-hidden text-graphite">
            {/* Left Panel: Role & Features */}
            <div className="w-[30%] h-full p-12 flex flex-col justify-center bg-blue-100 border-r border-black/10 z-10">
                <div className="mb-8">
                    <h2 className="text-4xl font-display font-bold text-black mt-2">Procurement</h2>
                    <p className="text-xl text-black/70 mt-4">Demand to Delivery, Unified.</p>
                </div>
